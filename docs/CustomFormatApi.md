...
with readarr.ApiClient(configuration) as api_client:
    ...
    api_instance = readarr.CustomFormatApi(api_client)
    custom_format_resource = readarr.CustomFormatResource() # CustomFormatResource |  (optional)
