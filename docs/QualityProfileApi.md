...
with readarr.ApiClient() as api_client:
    ...
    api_instance = readarr.QualityProfileApi(api_client)
    quality_profile_resource = readarr.QualityProfileResource() # QualityProfileResource |  (optional)
