...
with readarr.ApiClient(configuration) as api_client:
    ...
    api_instance = readarr.DownloadClientApi(api_client)
    force_save = False # bool |  (optional) (default to False)
    download_client_resource = readarr.DownloadClientResource() # DownloadClientResource |  (optional)
...
with readarr.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = readarr.DownloadClientApi(api_client)
    download_client_bulk_resource = readarr.DownloadClientBulkResource() # DownloadClientBulkResource |  (optional)
