...
with readarr.ApiClient(configuration) as api_client:
    ...
    api_instance = readarr.IndexerApi(api_client)
    force_save = False # bool |  (optional) (default to False)
    indexer_resource = readarr.IndexerResource() # IndexerResource |  (optional)
...
with readarr.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = readarr.IndexerApi(api_client)
    indexer_bulk_resource = readarr.IndexerBulkResource() # IndexerBulkResource |  (optional)
