...
class HistoryApi:
    ...
    def get_history(
        ...
        book_id: Optional[StrictInt] = None,
    ...
    def list_history_author(
        ...
        _param = self._list_history_author_serialize(
            author_id=author_id,
            book_id=book_id,
            event_type=event_type,
            include_author=include_author,
    ...
    @validate_call
    def list_history_author_with_http_info(
        self,
        author_id: Optional[StrictInt] = None,
        book_id: Optional[StrictInt] = None,
        event_type: Optional[EntityHistoryEventType] = None,
    ...
    @validate_call
    def list_history_author_without_preload_content(
        self,
        author_id: Optional[StrictInt] = None,
        book_id: Optional[StrictInt] = None,
        event_type: Optional[EntityHistoryEventType] = None,
    ...
    def _list_history_author_serialize(
        self,
        author_id,
        book_id,
        event_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/history/author',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
