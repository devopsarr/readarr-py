...
class EditionApi(object):
    ...
    def list_edition(self, book_id : Optional[conlist(StrictInt)] = None, **kwargs) -> List[EditionResource]:  # noqa: E501
        ...
        >>> thread = api.list_edition(book_id, async_req=True)
        >>> result = thread.get()
    ...
    def list_edition_with_http_info(self, book_id : Optional[conlist(StrictInt)] = None, **kwargs):  # noqa: E501
        ...
        >>> thread = api.list_edition_with_http_info(book_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(List[EditionResource], status_code(int), headers(HTTPHeaderDict))
        """
