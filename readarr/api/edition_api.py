...
class EditionApi:
    ...
    def list_edition(
        ...
        _param = self._list_edition_serialize(
            book_id=book_id,
    ...
    @validate_call
    def list_edition_with_http_info(
        self,
        book_id: Optional[List[StrictInt]] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[EditionResource]]:
        """list_edition
    ...
    @validate_call
    def list_edition_without_preload_content(
        self,
        book_id: Optional[List[StrictInt]] = None,
        _request_timeout: Union[
            None,
