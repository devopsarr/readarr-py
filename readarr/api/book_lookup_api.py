...
class BookLookupApi:
    ...
    def get_book_lookup(
        ...
        _param = self._get_book_lookup_serialize(
            term=term,
    ...
    @validate_call
    def get_book_lookup_with_http_info(
        self,
        term: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_book_lookup_without_preload_content(
        self,
        term: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_book_lookup_serialize(
        self,
        term,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/book/lookup',
