...
class ManualImportUpdateResource(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "path", "name", "authorId", "bookId", "foreignEditionId", "quality", "releaseGroup", "indexerFlags", "downloadId", "additionalFile", "replaceExistingFiles", "disableReleaseSwitching", "rejections"]
