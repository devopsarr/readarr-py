...
class BooksMonitoredResource(BaseModel):
    ...
    __properties = ["bookIds", "monitored"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BooksMonitoredResource:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BooksMonitoredResource:
        """Create an instance of BooksMonitoredResource from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return BooksMonitoredResource.parse_obj(obj)

        _obj = BooksMonitoredResource.parse_obj({
