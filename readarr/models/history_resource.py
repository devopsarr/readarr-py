...
class HistoryResource(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "bookId", "authorId", "sourceTitle", "quality", "customFormats", "customFormatScore", "qualityCutoffNotMet", "date", "downloadId", "eventType", "data", "book", "author"]
