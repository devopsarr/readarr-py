...
class NamingConfigResource(BaseModel):
    ...
    rename_books: Optional[StrictBool] = Field(default=None, alias="renameBooks")
    ...
    standard_book_format: Optional[StrictStr] = Field(default=None, alias="standardBookFormat")
    author_folder_format: Optional[StrictStr] = Field(default=None, alias="authorFolderFormat")
    include_author_name: Optional[StrictBool] = Field(default=None, alias="includeAuthorName")
    include_book_title: Optional[StrictBool] = Field(default=None, alias="includeBookTitle")
    ...
    __properties: ClassVar[List[str]] = ["id", "renameBooks", "replaceIllegalCharacters", "colonReplacementFormat", "standardBookFormat", "authorFolderFormat", "includeAuthorName", "includeBookTitle", "includeQuality", "replaceSpaces", "separator", "numberStyle"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.standard_book_format is None and "standard_book_format" in self.model_fields_set:
            _dict['standardBookFormat'] = None

        # set to None if author_folder_format (nullable) is None
        # and model_fields_set contains the field
        if self.author_folder_format is None and "author_folder_format" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "renameBooks": obj.get("renameBooks"),
            "replaceIllegalCharacters": obj.get("replaceIllegalCharacters"),
            "colonReplacementFormat": obj.get("colonReplacementFormat"),
            "standardBookFormat": obj.get("standardBookFormat"),
            "authorFolderFormat": obj.get("authorFolderFormat"),
            "includeAuthorName": obj.get("includeAuthorName"),
            "includeBookTitle": obj.get("includeBookTitle"),
