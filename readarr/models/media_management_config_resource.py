...
class MediaManagementConfigResource(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> MediaManagementConfigResource:
        ...
        _obj = MediaManagementConfigResource.parse_obj({
            "id": obj.get("id"),
            "auto_unmonitor_previously_downloaded_books": obj.get("autoUnmonitorPreviouslyDownloadedBooks"),
            ...
            "create_empty_author_folders": obj.get("createEmptyAuthorFolders"),
