...
class ManualImportResource(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "path", "name", "size", "author", "book", "foreignEditionId", "quality", "releaseGroup", "qualityWeight", "downloadId", "rejections", "audioTags", "additionalFile", "replaceExistingFiles", "disableReleaseSwitching"]
