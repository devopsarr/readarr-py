...
class ManualImportResource(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "path", "name", "size", "author", "book", "foreignEditionId", "quality", "releaseGroup", "qualityWeight", "downloadId", "indexerFlags", "rejections", "audioTags", "additionalFile", "replaceExistingFiles", "disableReleaseSwitching"]
