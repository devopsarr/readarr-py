...
class BookshelfAuthorResource(BaseModel):
    ...
    books: Optional[List]
    __properties = ["id", "monitored", "books"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BookshelfAuthorResource:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BookshelfAuthorResource:
        """Create an instance of BookshelfAuthorResource from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return BookshelfAuthorResource.parse_obj(obj)

        _obj = BookshelfAuthorResource.parse_obj({
            "id": obj.get("id"),
