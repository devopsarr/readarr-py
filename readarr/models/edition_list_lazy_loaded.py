...
class EditionListLazyLoaded(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EditionListLazyLoaded:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EditionListLazyLoaded:
        """Create an instance of EditionListLazyLoaded from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return EditionListLazyLoaded.parse_obj(obj)

        _obj = EditionListLazyLoaded.parse_obj({
            "value": [Edition.from_dict(_item) for _item in obj.get("value")] if obj.get("value") is not None else None,
