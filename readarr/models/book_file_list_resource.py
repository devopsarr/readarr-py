...
class BookFileListResource(BaseModel):
    ...
    """
    book_file_ids: Optional[List]
    quality: Optional[QualityModel]
    __properties = ["bookFileIds", "quality"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BookFileListResource:
    ...
    def to_dict(self):
        ...
        if self.book_file_ids is None:
            _dict['bookFileIds'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> BookFileListResource:
        """Create an instance of BookFileListResource from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return BookFileListResource.parse_obj(obj)

        _obj = BookFileListResource.parse_obj({
            "book_file_ids": obj.get("bookFileIds"),
