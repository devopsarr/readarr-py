...
class SeriesBookLinkListLazyLoaded(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeriesBookLinkListLazyLoaded:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SeriesBookLinkListLazyLoaded:
        """Create an instance of SeriesBookLinkListLazyLoaded from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return SeriesBookLinkListLazyLoaded.parse_obj(obj)

        _obj = SeriesBookLinkListLazyLoaded.parse_obj({
            "value": [SeriesBookLink.from_dict(_item) for _item in obj.get("value")] if obj.get("value") is not None else None,
