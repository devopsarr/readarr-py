...
class SeriesBookLinkListLazyLoaded(BaseModel):
    ...
    """ # noqa: E501
    value: Optional[List[SeriesBookLink]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [SeriesBookLink.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None,
...
SeriesBookLinkListLazyLoaded.model_rebuild(raise_errors=False)
