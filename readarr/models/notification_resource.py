...
class NotificationResource(BaseModel):
    ...
    on_author_added: Optional[StrictBool] = Field(default=None, alias="onAuthorAdded")
    on_author_delete: Optional[StrictBool] = Field(default=None, alias="onAuthorDelete")
    on_book_delete: Optional[StrictBool] = Field(default=None, alias="onBookDelete")
    on_book_file_delete: Optional[StrictBool] = Field(default=None, alias="onBookFileDelete")
    on_book_file_delete_for_upgrade: Optional[StrictBool] = Field(default=None, alias="onBookFileDeleteForUpgrade")
    ...
    on_book_retag: Optional[StrictBool] = Field(default=None, alias="onBookRetag")
    ...
    supports_on_author_added: Optional[StrictBool] = Field(default=None, alias="supportsOnAuthorAdded")
    supports_on_author_delete: Optional[StrictBool] = Field(default=None, alias="supportsOnAuthorDelete")
    supports_on_book_delete: Optional[StrictBool] = Field(default=None, alias="supportsOnBookDelete")
    supports_on_book_file_delete: Optional[StrictBool] = Field(default=None, alias="supportsOnBookFileDelete")
    supports_on_book_file_delete_for_upgrade: Optional[StrictBool] = Field(default=None, alias="supportsOnBookFileDeleteForUpgrade")
    ...
    supports_on_book_retag: Optional[StrictBool] = Field(default=None, alias="supportsOnBookRetag")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "onAuthorAdded": obj.get("onAuthorAdded"),
            "onAuthorDelete": obj.get("onAuthorDelete"),
            "onBookDelete": obj.get("onBookDelete"),
            "onBookFileDelete": obj.get("onBookFileDelete"),
            "onBookFileDeleteForUpgrade": obj.get("onBookFileDeleteForUpgrade"),
            "onHealthIssue": obj.get("onHealthIssue"),
            "onDownloadFailure": obj.get("onDownloadFailure"),
            "onImportFailure": obj.get("onImportFailure"),
            "onBookRetag": obj.get("onBookRetag"),
            ...
            "supportsOnAuthorAdded": obj.get("supportsOnAuthorAdded"),
            "supportsOnAuthorDelete": obj.get("supportsOnAuthorDelete"),
            "supportsOnBookDelete": obj.get("supportsOnBookDelete"),
            "supportsOnBookFileDelete": obj.get("supportsOnBookFileDelete"),
            "supportsOnBookFileDeleteForUpgrade": obj.get("supportsOnBookFileDeleteForUpgrade"),
            ...
            "supportsOnBookRetag": obj.get("supportsOnBookRetag"),
