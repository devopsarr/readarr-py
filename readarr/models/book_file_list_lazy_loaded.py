...
class BookFileListLazyLoaded(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BookFileListLazyLoaded:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BookFileListLazyLoaded:
        """Create an instance of BookFileListLazyLoaded from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return BookFileListLazyLoaded.parse_obj(obj)

        _obj = BookFileListLazyLoaded.parse_obj({
            "value": [BookFile.from_dict(_item) for _item in obj.get("value")] if obj.get("value") is not None else None,
