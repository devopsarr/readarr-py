...
class BookListLazyLoaded(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BookListLazyLoaded:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BookListLazyLoaded:
        """Create an instance of BookListLazyLoaded from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return BookListLazyLoaded.parse_obj(obj)

        _obj = BookListLazyLoaded.parse_obj({
            "value": [Book.from_dict(_item) for _item in obj.get("value")] if obj.get("value") is not None else None,
