...
class BookListLazyLoaded(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [Book.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None,
...
BookListLazyLoaded.model_rebuild(raise_errors=False)
