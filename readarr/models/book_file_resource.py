...
class BookFileResource(BaseModel):
    ...
    __properties = ["id", "authorId", "bookId", "path", "size", "dateAdded", "quality", "qualityWeight", "mediaInfo", "qualityCutoffNotMet", "audioTags"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BookFileResource:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BookFileResource:
        """Create an instance of BookFileResource from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return BookFileResource.parse_obj(obj)

        _obj = BookFileResource.parse_obj({
            "id": obj.get("id"),
