...
class AuthorStatisticsResource(BaseModel):
    ...
    """ # noqa: E501
    book_file_count: Optional[StrictInt] = Field(default=None, alias="bookFileCount")
    book_count: Optional[StrictInt] = Field(default=None, alias="bookCount")
    available_book_count: Optional[StrictInt] = Field(default=None, alias="availableBookCount")
    total_book_count: Optional[StrictInt] = Field(default=None, alias="totalBookCount")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bookFileCount": obj.get("bookFileCount"),
            "bookCount": obj.get("bookCount"),
            "availableBookCount": obj.get("availableBookCount"),
            "totalBookCount": obj.get("totalBookCount"),
            "sizeOnDisk": obj.get("sizeOnDisk"),
            "percentOfBooks": obj.get("percentOfBooks")
        })
        return _obj
