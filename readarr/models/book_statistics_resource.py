...
class BookStatisticsResource(BaseModel):
    ...
    __properties = ["bookFileCount", "bookCount", "totalBookCount", "sizeOnDisk", "percentOfBooks"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BookStatisticsResource:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BookStatisticsResource:
        """Create an instance of BookStatisticsResource from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return BookStatisticsResource.parse_obj(obj)

        _obj = BookStatisticsResource.parse_obj({
